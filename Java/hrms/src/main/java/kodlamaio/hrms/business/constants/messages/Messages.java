...
public class Messages {
	...
	// candidate
	public static String candidatesListed = "Namizədlər listələndi";
	public static String candidateAdded = "İş arayan eklendi";
	public static String candidateVerified = "Candidate Verified";
	...
	public static String employeesListed = "Sistem çalışanı listelendi";
